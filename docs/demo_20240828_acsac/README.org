...
the directory of your choice and setup a environment variable to its path:

#+begin_src bash :eval never
git clone https://github.com/pierreay/screaming_channels_ble/
export SC="$(realpath ./screaming_channels_ble)"
#+end_src
...
#+begin_src bash :eval never
cd "${SC}/docs/demo_20240828_acsac" && make build
#+end_src
