...
We will setup a temporary Docker container for reproducing the attacks. First,
move the downloaded datasets inside the Docker folder:
...
It will download around 2 GB. The image and containers will be cleaned up at
