...
# Attack 1:
./attack.py --no-log --no-plot --norm --dataset-path /home/drac/storage/dataset/240110_single-leak-pairing-1m-lna_raw --start-point 73837 --end-point 74237 --num-traces 3987 attack --attack-algo pcc --profile /home/drac/git/bluescream/data/profiles/231222_single-cable-balanced_raw/ --num-pois 2 --poi-spacing 1 --variable p_xor_k --align
