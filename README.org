...
can be found in the Ph.D. manuscript and in the documentation (see =docs=).
More precise demonstrations can be found in the experiments (see
=screaming_channels_data=).
